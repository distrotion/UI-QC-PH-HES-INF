...
abstract class HSTHI003_Event {}

class HSTHI003_READ extends HSTHI003_Event {}

class HSTHI003_Bloc extends Bloc<HSTHI003_Event, HSTHI003SCHEMA> {
  HSTHI003_Bloc()
      : super(HSTHI003SCHEMA(
          ItemPick: [''],
    ...
    on<HSTHI003_READ>((event, emit) {
      return _HSTHI003_READ(
          HSTHI003SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _HSTHI003_READ(
      HSTHI003SCHEMA toAdd, Emitter<HSTHI003SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "FINAL/HSTHI003db",
      data: {},
    );
    HSTHI003SCHEMA output = HSTHI003SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
