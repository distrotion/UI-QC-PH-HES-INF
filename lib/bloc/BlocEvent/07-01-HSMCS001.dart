...
abstract class HSMCS001_Event {}

class HSMCS001_READ extends HSMCS001_Event {}

class HSMCS001_Bloc extends Bloc<HSMCS001_Event, HSMCS001SCHEMA> {
  HSMCS001_Bloc()
      : super(HSMCS001SCHEMA(
          ItemPick: [''],
    ...
    on<HSMCS001_READ>((event, emit) {
      return _HSMCS001_READ(
          HSMCS001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _HSMCS001_READ(
      HSMCS001SCHEMA toAdd, Emitter<HSMCS001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "FINAL/HSMCS001db",
      data: {},
    );
    HSMCS001SCHEMA output = HSMCS001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
