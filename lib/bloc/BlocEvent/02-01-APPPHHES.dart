...
abstract class APPPHHES_Event {}

class APPPHHES_READ extends APPPHHES_Event {}

class APPPHHES_Bloc extends Bloc<APPPHHES_Event, APPPHHESSCHEMA> {
  APPPHHES_Bloc()
      : super(APPPHHESSCHEMA(
          ItemPick: [''],
    ...
    on<APPPHHES_READ>((event, emit) {
      return _APPPHHES_READ(
          APPPHHESSCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _APPPHHES_READ(
      APPPHHESSCHEMA toAdd, Emitter<APPPHHESSCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "FINAL/APPPHHESdb",
      data: {},
    );
    APPPHHESSCHEMA output = APPPHHESSCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
