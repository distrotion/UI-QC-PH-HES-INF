...
abstract class HSEWB008_Event {}

class HSEWB008_READ extends HSEWB008_Event {}

class HSEWB008_Bloc extends Bloc<HSEWB008_Event, HSEWB008SCHEMA> {
  HSEWB008_Bloc()
      : super(HSEWB008SCHEMA(
          ItemPick: [''],
    ...
    on<HSEWB008_READ>((event, emit) {
      return _HSEWB008_READ(
          HSEWB008SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _HSEWB008_READ(
      HSEWB008SCHEMA toAdd, Emitter<HSEWB008SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "FINAL/HSEWB008db",
      data: {},
    );
    HSEWB008SCHEMA output = HSEWB008SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
    ...
    if (response.statusCode == 200) {
      ...
      //     }
      //   }
      //   // if (databuff['FINAL_ANS'][HSEWB008var.ItemPickSELECT] != null) {
      //   //
      //   // }
      // }

      output = HSEWB008SCHEMA(
        UPDATE: 'OK',
        //---- Left
