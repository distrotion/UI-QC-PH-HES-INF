...
abstract class HSRGH001_Event {}

class HSRGH001_READ extends HSRGH001_Event {}

class HSRGH001_Bloc extends Bloc<HSRGH001_Event, HSRGH001SCHEMA> {
  HSRGH001_Bloc()
      : super(HSRGH001SCHEMA(
          ItemPick: [''],
    ...
    on<HSRGH001_READ>((event, emit) {
      return _HSRGH001_READ(
          HSRGH001SCHEMA(
            ItemPick: [''],
            ItemPickcode: [ITEMSET()],
            preview: [],
  ...
  Future<void> _HSRGH001_READ(
      HSRGH001SCHEMA toAdd, Emitter<HSRGH001SCHEMA> emit) async {
    //--------------- READ
    final response = await Dio().post(
      server + "FINAL/HSRGH001db",
      data: {},
    );
    HSRGH001SCHEMA output = HSRGH001SCHEMA(
      ItemPick: [''],
      ItemPickcode: [ITEMSET()],
      preview: [],
      confirmdata: [],
